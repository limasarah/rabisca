// Frontend client (vanilla) - moved to frontend/
// Backend URL resolution: use window.__BACKEND_URL__ if injected by hosting (Vercel),
// fall back to localhost during development or a placeholder for production.
const BACKEND_URL = window.__BACKEND_URL__ || (location.hostname === 'localhost' ? 'http://localhost:4000' : 'https://YOUR_BACKEND_URL_HERE');
